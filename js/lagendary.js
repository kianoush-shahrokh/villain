(function() {
    ...
    const productPrizes = [
        ...
        { icon: '', text: '33', value: '33' },
        { icon: '', text: '34', value: '34' },
        { icon: '', text: '35', value: '35' },
        { icon: '', text: '36', value: '36' },
        { icon: '', text: '37', value: '37' },
        { icon: '', text: '38', value: '38' },
        { icon: '', text: '39', value: '39' },
